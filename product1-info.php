...
<head>
    ...
    <title>Tom Ford Oud Wood - Le Fragrance</title>
...
<body>
    ...
    <section class="product-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <img src="images/tomford.jpg" class="img-fluid product-image" alt="Tom Ford Oud Wood">
                </div>
                <div class="col-lg-6">
                    <h1 class="product-title">Tom Ford Oud Wood</h1>
                    <p class="product-category text-uppercase small font-weight-bold" style="color: var(--secondary-color);">PARFUMS</p>
                    <p class="product-description">
                        Deze exclusieve houtachtige geur combineert rijke tonen van Oud hout met exotische specerijen en 
                        warme vanille. Een tijdloze geur die kracht en verfijning uitstraalt, perfect voor speciale gelegenheden.
                    </p>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('form').submit(function(e) {
                ...
                console.log(`Tom Ford Oud Wood (${quantity}x) toegevoegd aan winkelwagen`);
