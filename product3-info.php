...
<head>
    ...
    <title>Yves Saint Laurent Y Eau de Parfum - Le Fragrance</title>
...
<body>
    ...
    <section class="product-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <img src="images/bif.jpg" class="img-fluid product-image" alt="Yves Saint Laurent Y Eau de Parfum">
                </div>
                <div class="col-lg-6">
                    <h1 class="product-title">Yves Saint Laurent Y Eau de Parfum</h1>
                    <p class="product-category text-uppercase small font-weight-bold" style="color: var(--secondary-color);">PARFUMS</p>
                    
                    <div class="product-highlight">
                        "Een krachtige geur die de moderniteit van de man van vandaag weerspiegelt"
                    </div>
                    
                    <p class="product-description">
                        Y Eau de Parfum belichaamt de moderne man met zijn verleidelijke mix van frisse citrusnoten en 
                        warme houtachtige akkoorden. Deze intense versie van het iconische Y-parfum combineert de 
                        levendigheid van bergamot met de diepte van tonkaboon en sandelhout voor een tijdloze elegantie.
                    </p>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('form').submit(function(e) {
                ...
                console.log(`Yves Saint Laurent Y Eau de Parfum (${quantity}x) toegevoegd aan winkelwagen`);
